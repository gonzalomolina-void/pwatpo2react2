      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <nav className="hidden md:flex gap-6">
            <Link to="/" className="text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-sm font-medium uppercase tracking-wider">Home</Link>
            <Link to="/favoritos" className="text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-sm font-medium uppercase tracking-wider">Favoritos</Link>
          </nav>
